...
<style>
  ...
  .ref-tbl tr:hover td{background:rgba(200,84,60,.06)}
</style>
</head>
<body>
...
<section style="background:var(--navy2);border-bottom:1px solid var(--border);padding:48px 0;">
  <div class="wrap">
    <div style="display:grid;grid-template-columns:repeat(4,1fr);gap:20px;text-align:center;">
      <?php foreach([
        ['30-Day Returns','Return any unworn pair within 30 days.'],
      ...
      <div>
        <div style="width:28px;height:3px;background:var(--accent);border-radius:2px;margin:0 auto 14px;"></div>
        <div style="font-family:'Oswald',sans-serif;font-size:.9rem;letter-spacing:1px;color:var(--white);margin-bottom:6px;"><?=htmlspecialchars($k[0])?></div>
        <div style="font-size:.8rem;color:var(--muted);"><?=htmlspecialchars($k[1])?></div>
      </div>
      <?php endforeach; ?>
    </div>
  </div>
  ...
  <div class="wrap" style="max-width:860px;">
    ...
    <div class="info-card">
      ...
      <ul style="list-style:none;display:flex;flex-direction:column;gap:10px;">
        <?php foreach([
          ...
          'Custom or design-requested shoes (personalised orders are final)',
    ...
    <div class="info-card">
      ...
      <div style="display:flex;flex-direction:column;gap:0;">
        <?php foreach([
          ['1','Email us at ApexStore@gmail.com','Include your Order ID, reason for return, and whether you want a refund or exchange.'],
    ...
    <div class="info-card">
      ...
      <div style="overflow-x:auto;border-radius:8px;overflow:hidden;border:1px solid var(--border);">
        <table class="ref-tbl">
          <thead><tr><th>Payment Method</th><th>Refund Processing Time</th><th>Total Est. Time</th></tr></thead>
          <tbody>
            <?php foreach([
              ['Credit / Debit Card (Visa & Mastercard)','5–7 business days','7–10 business days'],
              ['Online Banking (FPX)','3–5 business days','5–7 business days'],
              ['GrabPay','1–3 business days','3–5 business days'],
              ['Touch \'n Go eWallet','1–3 business days','3–5 business days'],
              ['Boost','1–3 business days','3–5 business days'],
            ] as $r): ?>
    ...
    <div class="info-card" style="border-color:rgba(200,84,60,.3);background:rgba(200,84,60,.04);">
