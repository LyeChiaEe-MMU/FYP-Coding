...
.apex-nav {
    ...
    box-shadow:0 2px 12px rgba(110,65,45,0.08);
...
.apex-logo {
    ...
    letter-spacing:4px;color:#1C1410;flex-shrink:0;text-decoration:none;
}
.apex-logo span{color:#C8543C}

/* Search */
.apex-search{flex:1;max-width:360px;position:relative}
.apex-search input{
    width:100%;background:#FFFFFF;
    border:1.5px solid rgba(150,100,75,.2);border-radius:100px;
...
#apex-sdrop{
    ...
    box-shadow:0 12px 36px rgba(110,65,45,.14);
}
#apex-sdrop a{
...
#apex-sdrop a:hover{background:rgba(0,137,123,.05)}
...
.apex-right a{
    ...
    color:#7A6A64;border-radius:var(--radius);
...
.apex-main-nav{
    ...
    background:rgba(245,236,228,.98);
}
.apex-main-inner{
    max-width:1200px;margin:0 auto;padding:0 24px;
...
.mni-btn{
    ...
    color:#6A5A54;background:none;border:none;cursor:pointer;
...
.mni-link{
    display:block;padding:14px 22px;
    font-family:'Oswald',sans-serif;font-size:.95rem;letter-spacing:2px;
    color:#6A5A54;text-decoration:none;
    border-bottom:3px solid transparent;transition:all .2s;white-space:nowrap;font-weight:600;
}
...
.mega-panel{
    ...
    border-bottom:1px solid var(--border);
    box-shadow:0 16px 48px rgba(110,65,45,.12);
    z-index:998;
...
.mega-feat-card{
    ...
    color:var(--text);transition:all .2s;background:var(--navy2);
    display:block;
}
...
.apex-burger span{width:22px;height:2px;background:#6A5A54;border-radius:2px;display:block}
...
.apex-mob{
    ...
    box-shadow:0 8px 24px rgba(110,65,45,.1);
}
.apex-mob.mob-open{display:flex}
.apex-mob a{
    padding:11px 14px;border-radius:var(--radius);
    color:#6A5A54;font-size:.9rem;font-weight:500;
    text-decoration:none;transition:all .15s;
}
.apex-mob a:hover{color:var(--white);background:rgba(0,137,123,.07)}
.apex-mob .mob-group{
    font-size:.65rem;letter-spacing:3px;text-transform:uppercase;
    color:#9A8880;padding:12px 14px 4px;font-weight:700;
}
